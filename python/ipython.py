...
# WARN IF RUNNING IN VENV W/ NO IPYTHON INSTALLED I.E. USING GLOBAL IPYTHON
...
# lines at bottom of screen reserved for tab completion; bigger = longer/skinnier menus
...
# in ipython, autocomplete is ctrl e. how to remap? note: i am not talking about tab completion.
# c.TerminalInteractiveShell.shortcuts = [
#     ('tab', 'complete-next'),
#     ('s-tab', 'complete-previous')  # shift-tab
# ]
# c.TerminalInteractiveShell.shortcuts = {
#     'tab': ['complete-next']
# }
# c.TerminalInteractiveShell.shortcuts = [
#     'ctrl-e': 'complete'  # This would unbind it
#     'ctrl-x': 'end-of-line'
#     {"command": "IPython:auto_suggest.accept_character", "new_keys": ["right"]},
...
#  Default: "Python 3.12.5 (main, Aug 27 2024, 10:59:55) [Clang 15.0.0 (clang-1500.3.9.4)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.28.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.12.5 (main, Aug 27 2024, 10:59:55) [Clang 15.0.0 (clang-1500.3.9.4)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.28.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.banner1 = "Python 3.12.5 (main, Aug 27 2024, 10:59:55) [Clang 15.0.0 (clang-1500.3.9.4)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.28.0 -- An enhanced Interactive Python. Type '?' for help.\n"
