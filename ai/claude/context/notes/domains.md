...
│   │   └── SEARCH: 汉字, tones, radicals, DeFrancis, Link
│   │   └── HEADERS: ZA, grammar, classical, phrases, PORTED, education, math, travel, film, mating, opinion, medicine, software, shopping, music, food
│   ├── nascent.md
│   │   └── TOPICS: language learning methods
│   └── spanish.md
...
│   └── RELATED: sw/lang/plt.md
│   └── HEADERS: ⭕️ GUTS, grammar, morphology, taxonomy, 🎨 LANGUAGES, Chinese, English, ☯️ META, determinism, learning, writing, 🟨️ ZA, extinction, reform
├── media.md
│   └── TOPICS: chat apps, forums, journalism, attention
│   └── SEARCH: Slack, Discord, Zulip, Wu, Gurri
│   └── HEADERS: 📡 COMMS, chat, forum, meeting, memo, presentation, television, video, 🍽️ CONSUMPTION, newsletter, 🟧 podcast (Podcast Addict), 🐇 RSS (Feedrabbit), search, YT, ☸️ META, long tail, print culture, social, virtualism, 🟨️ ZA, journalism, self publishing, video
├── philosophy.md
│   └── TOPICS: epistemology, ethics, causation, logic, fallacies
...
└── HEADERS: 🔥 hair on fire, EOM/Q/Y, clean up, 2317, 🏦 BALANCE, assets, cash flow, 🏡 REAL ESTATE, where to live, purchasing, mortgage, insurance / taxes, 💸 TAXES, forms, calculating, 🟨️ ZA, auto, credit score, healthcare, possessions, retirement
    ...
    └── physics.md
        ...
        └── HEADERS: 🔭 MECHANICS, ⚡️ ELECTROMAGNETISM, electricity, 🌊 WAVES, sound, 🟨 ZA, cosmology
```
